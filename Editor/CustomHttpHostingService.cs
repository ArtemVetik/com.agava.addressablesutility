...
namespace Agava.AddressablesUtility.Editor
{
    ...
    /// </summary>
    public class CustomHttpHostingService : BaseHostingService
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a new <see cref="CustomHttpHostingService"/>
        /// </summary>
        public CustomHttpHostingService()
        {
        ...
        /// <summary>
        /// Destroys a <see cref="CustomHttpHostingService"/>
        /// </summary>
        ~CustomHttpHostingService()
        {
            StopHostingService();
        }
